...
def main():
    ...
    if response:
        ...
        if similarity_feedback["match"]:
            ...
            st.warning("Your response could be improved. Let’s go step by step. There are two parts to this question, each should be written in clear, concise, academic style.")
            ...
            # Multiple Choice for Understanding the Text
            st.subheader("Understanding the Concept")
            intelligence = st.radio("What does this mean about intelligence?", ["Everyone had the same intelligence", "Everyone had different intelligence"], key="intelligence_check")
            if intelligence == "Everyone had the same intelligence":
                st.warning("Not quite. The government tried to make intelligence equal, but people were naturally different.")
            
            strength = st.radio("What does this mean about strength?", ["Everyone had the same strength", "Everyone had different strength"], key="strength_check")
            if strength == "Everyone had the same strength":
                st.warning("Not exactly. Some people were stronger than others, but the government used handicaps to make them appear equal.")
            
            beauty = st.radio("What does this mean about beauty?", ["Everyone was equally beautiful", "Some people were naturally more beautiful"], key="beauty_check")
            if beauty == "Everyone was equally beautiful":
                st.warning("Not quite. The government made sure beautiful people were covered so no one seemed more attractive.")
        ...
        rewritten_answer = st.text_area("Now, rewrite your answer to the original question: 'What is the purpose of the handicaps used in the society of Harrison Bergeron? Give examples of different types of handicaps used AND the purpose of each.' Combine your previous two answers into a more complete response:", key="rewritten_answer")
